...
fun EditSpaceForm(
    ...
    Column(
        ...
        InputSpaceN(
            ...
            value = spaceViewModel.spaceState.spaceEditName,
        ...
        Row(
            ...
            OSButton(
                onClick = {
                    ...
                    val name = state.spaceEditName
                    val spaceID = state.spaceEdit.spaceID.toString()

                    val modelSpaceDTO = SpaceDTO(name)
                    spaceViewModel.updateSpace(modelSpaceDTO, spaceID)
...
fun InputSpaceN(
    ...
    OutlinedTextField(
        modifier = modifier,
        value = value,
        onValueChange = { spaceViewModel.changeSpaceName(it) },
        label = {
            Text(
                text = placeholder,
